...
import validator, {Validator} from "../../Validations/Validator.jsx";
                ...
                <Flex align='center' justify='center'>
                    <Form layout='vertical' className='contact-form' form={form} onFinish={sendEmail}>
                        <Form.Item label="Full Name" name='user_name'
                                   rules={[{required: true, validator: validator.validateName}]}>
                            <Input size='large' placeholder='Enter your name'/>
                        </Form.Item>
                        <Form.Item label="Email" name='user_email'
                                   rules={[{required: true, validator: validator.validateEmail}]}>
                            <Input size='large' placeholder='Enter your email'/>
                        </Form.Item>
                        <Form.Item label="Message" name='message'
                                   rules={[{required: true, validator: validator.validateMessage}]}>
                            <Input.TextArea style={{height: "100px"}} size='large'
